...
import '../drop_downs/issued_state_dropdown.dart';
...
class _MyPrRegState extends State<MyPrReg> {
  //var and controllers for MyPrExpanded Tile
  DateTime? _mydate;
      ...
      child: Container(
        ...
        child: ExpansionTile(
          ...
          children: [
            ...
            getExpiryDateFormMyPR(context),

            //dropdown class called
  ...
  Padding getExpiryDateFormMyPR(BuildContext context) {
    return Padding(
  ...
  Padding setTitleMyPrExpansionTile() {
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Container(
